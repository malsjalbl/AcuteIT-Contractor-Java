...
contractModule.value('MODULE_DISPLAY_NAME', 'Contract');
contractModule.value('MODULE_HOME_URL', '#/contracts/page/1');

contractModule.value('OPTION_DISPLAY_NAME_CONTRACTS', 'Contracts');
contractModule.value('OPTION_HOME_URL_CONTRACTS', '#/contracts/page/1');

contractModule.value('OPTION_DISPLAY_NAME_COMPANIES', 'Companies');
contractModule.value('OPTION_HOME_URL_COMPANIES', '#/companies/page/1');

contractModule.value('OPTION_DISPLAY_NAME_ACTIVITY_CODES', 'Activity Codes');
contractModule.value('OPTION_HOME_URL_ACTIVITY_CODES', '#/contract_activity_types/page/1');
 
contractModule.run(
		
		 function(mainService, contractService, contractActivityTypeService) {
